DEVICE_TREE := device/samsung/graceltekor
...
TARGET_KERNEL_VARIANT_DEFCONFIG := variant_gracelte_kor
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --board SRPPD26B000RU
...
TARGET_INIT_VENDOR_LIB := libinit_graceltekor
TARGET_RECOVERY_DEVICE_MODULES := libinit_graceltekor
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_graceltekor.cpp
